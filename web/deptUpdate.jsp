...
<body>
    ...
    <form action="gugu/DeptServlet?method=deptChange" method="post">
        <ul class="forminfo">
            <li><label>部门编号</label><input name="deptno" type="text" readonly class="dfinput" value="${requestScope.dept.deptno}"/>${requestScope.msg} </li>
